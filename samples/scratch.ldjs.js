...
n = vc.addops([
    vc.multops([c.top("constant", { color: c.rgbp(c.fp(0), c.fp(1), c.fp(0)) ,  }), vc.addedtop(`Changes`)]),
    vc.multops([c.top("constant", { color: c.rgbp(c.fp(1), c.fp(0), c.fp(0)) }), vc.removedtop(`Changes`)]),
])
